...
import iql.web.system.dao.UserDao;
...
public class UserDaoImpl implements UserDao {
    ...
    public User findByUsername(String username) {
        String sql = "select id, username, `password`, real_name, phone, create_time, status, type, isfirstlogin,token from t_user where username=:username";
    ...
    public User findUserByToken(String token) {
        String sql = "select id, username, `password`, real_name, phone, create_time, status, type, isfirstlogin, token from t_user where token=:token";
        Query query = em.createNativeQuery(sql, User.class);
